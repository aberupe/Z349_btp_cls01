CLASS zcl_3491_carga_bib DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_3491_carga_bib IMPLEMENTATION.
METHOD if_oo_adt_classrun~main.


"NEW CHANGE

    data: lt_acc_categ type table of z3491_acc_categ,
          lt_catego    type table of z349_catego,
          lt_clientes  type table of z3491_clientes,
          lt_clnts_lib type table of z3491_clnts_lib,
          lt_libros    type table of z3491_libros.
...
******** TABLA1 ********
    ...
    delete from z3491_acc_categ.
    insert z3491_acc_categ from table @lt_acc_categ.
...
******** z349_catego ********
    ...
    "Delete possible entries; insert new entries
    delete from z349_catego.
    insert z349_catego from table @lt_catego.
...
******** z3491_clientes ********
    ...
    "Delete possible entries; insert new entries
    delete from z3491_clientes.
    insert z3491_clientes from table @lt_clientes.
...
******** z3491_clnts_lib
    ...
    "Delete possible entries; insert new entries
    delete from z3491_clnts_lib.
    insert z3491_clnts_lib from table @lt_clnts_lib.
...
******** z3491_libros ********
    ...
    'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' ) ).
    "Delete possible entries; insert new entries
    delete from z3491_libros.
    insert z3491_libros from table @lt_libros.
